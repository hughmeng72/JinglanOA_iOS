...
class ReviewViewController: UIViewController, XMLParserDelegate {
    ...
    private let soapMethod = "GetMissedFlowReviwer"
    private let soapUpdateMethod = "UpdateFlowReviewer"
